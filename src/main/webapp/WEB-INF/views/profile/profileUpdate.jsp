...
<body>
	<div class="container">
		<li><a href="/profile/select">戻る</a></li>
		<c:forEach var="profile" items="${profileList }" varStatus="status">
			<div class="profileList" id ="profileList${status.index }">
				...
				<div class="profileName" >
					...
					<div class="btnSpace">
					<button class="nameChange" id="nameChange${status.index }" onclick="nameChange(${status.index})"><img src="/img/baseImage/modifyPan.jpg"></button>
