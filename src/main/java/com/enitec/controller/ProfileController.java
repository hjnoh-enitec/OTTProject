...
public class ProfileController {
	...
	public String moveProfilePage(String toURL, HttpServletRequest request, HttpServletResponse res, Model model) {
		...
		model.addAttribute("m_code", cs.getMembershipCode(c_id.toString()));
		return "profile/profile";
	}

	@PostMapping("/select")
	public String selectedCustomerProfile(SelectProfileForm spf, HttpServletRequest request, HttpServletResponse res, Model model) {
